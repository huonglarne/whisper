...
def cli():
    ...
    parser.add_argument("--audio", default=["tests/jfk.flac"], nargs="+", type=str, help="audio file(s) to transcribe")
    ...
    parser.add_argument("--fp16", type=str2bool, default=False, help="whether to perform inference in fp16; False by default")
